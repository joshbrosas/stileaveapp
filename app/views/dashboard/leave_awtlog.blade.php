    ...
    <div class="row">
        ...
        <div class="col-xs-8">
            <div class="panel panel-body">
                <h3><strong class="help-block">Recent Application for Authorization To Work (ATW)</strong></h3>
                <hr>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <p class="form-control-static"><strong>Application for Authorization To Work (ATW)</strong></p>
                        </div>
                    </div>
                ...
                <div class="col-sm-offset-1 col-sm-9">
                   ...
                   <div class="form-group">
                      <div class="col-xs-offset-1 col-xs-9">
                           <a class="btn btn-sm btn-danger"  href="{{ URL::to('delete_atw/'.$getleave->leave_id) }}"><i class="fa fa-remove"></i> Remove this application </a>
                      </div>
                   </div>
                   @endif
