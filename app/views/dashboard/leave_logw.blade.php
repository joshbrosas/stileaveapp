    ...
    <div class="row">
        <div class="col-xs-3">
            ...
            <div class="list-group">
                ...
                @if(count($rleave) === 0)
                    <a class="list-group-item" id="recentleave">No leave yet.</a>
                @else
        ...
        <div class="col-xs-8">
            <div class="panel panel-body">
                <h3><strong class="help-block">Recent Leave (without Pay)</strong></h3>
                <hr>
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <p class="form-control-static"><strong>Leave without Pay</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <p id="plabel" class="col-sm-5 control-label"><strong>Reason for the availment of leave:</strong> </p>
                    </div>
                    <hr>
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-9">
                            <p id="pef">{{ nl2br($getleave->reason) }}</p>
                        </div>
                    </div>
                    <hr>
                   ...
                   <div class="form-group">
                      <div class="col-xs-offset-1 col-xs-9">
                            <a class="btn btn-sm btn-danger"  href="{{ URL::to('deleteleavew/'.$getleave->leave_id) }}"><i class="fa fa-remove"></i> Delete this leave</a>
                      </div>
                   </div>
                   @endif
