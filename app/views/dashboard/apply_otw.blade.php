    ...
    <div class="row">
        <div class="col-xs-3">
            ...
            <div class="list-group fontsize">
                ...
                <a href="{{ URL::route('applyatw') }}" class="list-group-item tip-bottom actives" data-toggle="tooltip"  data-original-title="Application for Authority to Work (ATW)"> Application for (ATW)<span class="pull-right glyphicon glyphicon-chevron-right"></span></a>
        ...
        <div class="col-xs-8">
          <div class="panel panel-body">
              <h3><strong class="help-block">Application for Authority to Work (ATW)</strong></h3>
            <br>
              ...
              <b>To be filed 1 day before the intended work day extension. </b>
              </p>
              <hr>
              <br>
             {{ Form::open(array('url' => 'awtleave', 'method' => 'post', 'class' => 'form-horizontal', 'autocomplete' => 'off')) }}
