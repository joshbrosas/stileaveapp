...
<div class="container" id="mfcont">
    ...
    <div class="col-xs-3">
        ...
        <div class="list-group fontsize">
            ...
            <a href="leavewopay" class="list-group-item tip-bottom actives"  data-toggle="tooltip"  data-original-title="{{ $countleave->remaining_leave_wopay }} remaining leave." ><span class="badge">{{ $countleave->remaining_leave_wopay }}</span> Leave without Pay</a>
            ...
            <a href="{{ URL::route('applyatw') }}" class="list-group-item tip-bottom" data-toggle="tooltip"  data-original-title="Application for Authority to Work (OTW)"> Application for (ATW)<span class="pull-right glyphicon glyphicon-chevron-right"></span></a>
        ...
        <div class="col-xs-8">
            <div class="panel panel-body">
                <h3><strong class="help-block">EMPLOYEE LEAVE APPLICATION FORM <small> (Without Pay)</small></strong></h3>
                <br>
                ...
                <p class="bg-info" id="bginfo">
                    This form should be applied before the day of leave.
                </p>
                <hr>
                <br>
                {{ Form::open(array('url' => 'wopleave/'.$profile->employee_id, 'method' => 'put', 'class' => 'form-horizontal', 'autocomplete' => 'off')) }}
                ...
                <div class="form-group">
                    <p id="plabel" class="col-sm-3 control-label">Employment Status: </p>
                    <div class="col-sm-8">
                        <input type="text" value="{{ ucfirst($profile->e_status) }}" class="txtget" readonly >
                    </div>
                </div>
...
<input type="hidden" name="totalleaves" class="form-control" id="totalleaves" readonly>
                <div class="form-group">
                    <p id="plabel" class="col-sm-5 control-label">Reason for the availment of leave: </p>
                </div>

                <div class="form-group has-feedback">
                    <div class="col-sm-offset-1 col-md-11">
                        <span class="@if($errors->has('reason')) has-error @endif"><textarea class="form-control textlist" id="text2" name="reason"  placeholder="Type text....."></textarea></span>
