    ...
    <div class="row">
        <div class="col-xs-3">
            ...
            <div class="list-group">
                <a class="list-group-item active">Recent Leave (with Pay)</a>
                @if(count($rleave) === 0)
        ...
        <div class="col-xs-8">
            <div class="panel panel-body">
                <h3><strong class="help-block">Recent Leave (with Pay)</strong></h3>
                <hr>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <p class="form-control-static"><strong>Leave with Pay</strong></p>
                        </div>
                    </div>
                ...
                @if($getleave->status !== '')
                    <div class="form-group">
                       <div class="col-xs-offset-1 col-xs-9">
                           <a class="btn btn-sm btn-danger"  href="{{ URL::to('deleteleave/'.$getleave->leave_id) }}"><i class="fa fa-remove"></i> Delete this leave</a>
                       </div>
                   </div>
                 @endif
