    ...
    <div class="row">
        <div class="col-xs-3">
            ...
            <div class="list-group fontsize">
                ...
                <a href="leavepay" class="list-group-item tip-bottom actives"  data-toggle="tooltip"  data-original-title="{{ $countleave->remaining_leave }} remaining leave." ><span class="badge">{{ $countleave->remaining_leave }}</span> Leave with Pay</a>
        ...
        <div class="col-xs-8">
          <div class="panel panel-body">
              <h3><strong class="help-block">EMPLOYEE LEAVE APPLICATION FORM<small> (With Pay)</small></strong></h3>
            <br>
              ...
              <hr>
              <br>
             {{ Form::open(array('url' => 'wpleave/'.$profile->employee_id, 'method' => 'put', 'class' => 'form-horizontal', 'autocomplete' => 'off')) }}
                  ...
                  <div class="form-group has-feedback">
                      <div class="col-sm-offset-1 col-md-11">
                          <span class="@if($errors->has('reason')) has-error @endif"><textarea class="form-control" id="text2" name="reason"  placeholder="Type text....."></textarea></span>
