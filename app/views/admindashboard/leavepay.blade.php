...
<div class="container" id="mfcont">
        ...
        <div class="col-xs-3" id="prof">
         ...
         {{ HTML::image('img/naga.jpg', 'stinaga', array('class' => 'img-responsive', 'id' => 'coverlogo'))  }}
            ...
            <div class="list-group">
                ...
                <a href="{{ URL::route('approve') }}" class="list-group-item">Recent Leave (with pay) <span class="glyphicon glyphicon-chevron-right pull-right"></span> </a>
    ...
    <div class="col-xs-6" id="stat">
        <p class="bg-info" id="bginfo">
            <i class="fa fa-info-circle"></i> <strong>Pending Leave (with pay)</strong>
        </p>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div id="{{ $leavewithpay->id }}" style="display: none">
                    {{ Form::open(array('url' => 'approval/'.$leavewithpay->leave_id, 'method' => 'post', 'class' => 'form-horizontal')) }}
