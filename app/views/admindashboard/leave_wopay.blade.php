    ...
    <div class="row">
        <div class="col-xs-3" id="prof">
            ...
            <div class="list-group">
                ...
                <a href="{{ URL::route('administrator') }}" class="list-group-item"><span class="glyphicon glyphicon-chevron-left"></span> Control Panel</a>
            </div>

            <div class="list-group">
                <a class="list-group-item active">Recent Leave logs</a>
                <a href="{{ URL::route('wo_approve') }}" class="list-group-item">Recent Leave (without pay) <span class="glyphicon glyphicon-chevron-right"></span> </a>
            </div>
        ...
        <div class="col-xs-6" id="stat">
            <p class="bg-info" id="bginfo">
                <i class="fa fa-info-circle"></i> <strong>Pending Leave (without pay)</strong>
            </p>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div id="{{ $leavewithpay->id }}" style="display: none">
                            {{ Form::open(array('url' => 'wo_approval/'.$leavewithpay->leave_id, 'method' => 'post', 'class' => 'form-horizontal')) }}
