    ...
    <div class="row">
        <div class="col-xs-3" id="prof">
            ...
            <div class="list-group">
                ...
                <a href="{{ URL::route('leavepay') }}" class="list-group-item"><span class="glyphicon glyphicon-chevron-left"></span> Pending Leave</a>
        ...
        <div class="col-xs-6" id="stat">
                ...
                <p class="bg-info" id="bginfo">
                    <i class="fa fa-info-circle"></i> <strong>(Leave with pay) logs.</strong>
                </p>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading text-primary"><strong>{{ ucfirst($leavewithpay->user->firstname) }} {{ ucfirst($leavewithpay->user->surname) }}
                                        <span class="pull-right"><a id="glp" href="{{ URL::to('deletepayleave/'.$leavewithpay->leave_id) }}" data-toggle="tooltip" class="btn-approve tip-bottom" data-original-title="Remove this post"><span class="glyphicon glyphicon-remove"></span> </a></span></strong></h4>
