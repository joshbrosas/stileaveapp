...
<div class="container" id="mfcont">
        ...
        <div class="col-xs-3" id="prof">
         ...
         {{ HTML::image('img/naga.jpg', 'stinaga', array('class' => 'img-responsive', 'id' => 'coverlogo'))  }}
            ...
            <div class="list-group">
                ...
                <a href="{{ URL::route('recent_atw') }}" class="list-group-item"> Recent ATW Logs <span class="pull-right glyphicon glyphicon-chevron-right"></span> </a>
            </div>
    ...
    <div class="col-xs-6" id="stat">
        <p class="bg-info" id="bginfo">
            <i class="fa fa-info-circle"></i> <strong>Application for Authorization to Work (ATW)</strong>
        </p>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div id="{{ $leavewithpay->id }}" style="display: none">
                    {{ Form::open(array('url' => 'approval_awt/'.$leavewithpay->leave_id, 'method' => 'post', 'class' => 'form-horizontal')) }}
                    ...
                    <button type="submit" id="btn_pdse" STYLE="margin-top: 5px;" class="btn btn-sm">Submit</button>
                    {{ Form::close() }}
                </div>
            </div>
        </div>
