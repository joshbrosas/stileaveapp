...
<div class="row">
    ...
    <div class="col-xs-9">
        <div class="panel panel-body">
            <h3><strong><i class="fa fa-user-secret"></i> Create Administrator</strong></h3>
            <hr>
            <div class="col-md-10 col-md-offset-1">
                ...
                @endif
                {{ Form::open(array('url' => 'r_admin', 'class' => 'form-horizontal', 'method' => 'post')) }}
                <p class="help-block">User Account</p>
                <hr>
                <div class="form-group has-feedback">
                    <label for="inputEmail3" class="col-xs-3 control-label">Username:</label>
                    <div class="col-xs-6">
                ...
                <div class="form-group has-feedback">
                    <label for="inputPassword3" class="col-xs-3 control-label">Repeat Password:</label>
                    <div class="col-xs-6">
                ...
                <div class="form-group has-feedback">
                    <label for="inputEmail3" class="col-xs-3 control-label">Employee ID:</label>
                    <div class="col-xs-6">
                ...
                <div class="form-group has-feedback">
                    <label for="inputPassword3" class="col-xs-3 control-label">Firstname:</label>
                    <div class="col-xs-6">
                ...
                <div class="form-group has-feedback">
                    <label for="inputPassword3" class="col-xs-3 control-label">Surname:</label>
                    <div class="col-xs-6">
                ...
                <div class="form-group has-feedback">
                    <label for="inputPassword3" class="col-xs-3 control-label">Department:</label>
                    <div class="col-xs-6">
